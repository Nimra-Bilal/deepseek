...
const Sidebar = ({expand , setExpand}) => {
  ...
  return (
    ...
    pt-7 transition-all z-50 max-md:h-screen 
    ${expand? 'p-4 w-64 ' : 'md:w-20 w-0 max-md:overflow-hidden'}`}>
        ...
        <div className={`flex ${expand ? "flex-row gap-10": "flex-col items-center gap-8"}`}>
            ...
            text-sm px-3 py-2 rounded-lg pointer-events-none'>
                New Chat
                <div 
            className='w-3 h-3 absolute bg-black rotate-45 left-4 -bottom-1.5'></div>
            </div>
